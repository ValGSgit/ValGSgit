      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Experience & <span className="bg-gradient-to-r from-emerald-400 to-cyan-500 bg-clip-text text-transparent">Education</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            >
              <div className="w-10 h-10 rounded-lg bg-gradient-to-r from-emerald-500 to-cyan-600 flex items-center justify-center">
                🎓
              </div>
              Education
            </motion.h3>
            ...
            <div className="relative">
              {/* Timeline Line */}
              <div className="absolute left-6 top-0 bottom-0 w-px bg-gradient-to-b from-emerald-500 via-cyan-500 to-transparent" />
              ...
              {education.map((edu, index) => (
                ...
                >
                  {/* Timeline Dot */}
                  <div className="absolute left-4 top-1 w-4 h-4 rounded-full bg-gradient-to-r from-emerald-500 to-cyan-600 border-4 border-zinc-900" />

                  <div className="bg-zinc-800/50 backdrop-blur-sm rounded-xl p-6 border border-zinc-700/50 hover:border-emerald-500/30 transition-all">
                    ...
                    {edu.description && (
                      <p className="text-zinc-400 text-sm mb-3">{edu.description}</p>
                    )}
          ...
          <div>
            ...
            <div className="relative">
              ...
              {experience.map((exp, index) => (
                ...
                >
                  {/* Timeline Dot */}
                  <div className="absolute left-4 top-1 w-4 h-4 rounded-full bg-gradient-to-r from-green-500 to-emerald-600 border-4 border-zinc-900" />

                  <div className="bg-zinc-800/50 backdrop-blur-sm rounded-xl p-6 border border-zinc-700/50 hover:border-green-500/30 transition-all">
                    <div className="flex flex-wrap items-center gap-2 mb-2">
                      <span className="px-3 py-1 bg-green-500/20 text-green-400 text-xs font-medium rounded-full">
                        {exp.period}
                      </span>
                      <span className="px-3 py-1 bg-zinc-700 text-zinc-300 text-xs font-medium rounded-full">
                        {exp.type}
                      </span>
                    </div>
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            <div className="bg-zinc-800/50 backdrop-blur-sm p-6 rounded-xl border border-zinc-700/50 text-center">
              ...
              <p className="text-emerald-400 font-medium">Native</p>
              <p className="text-sm text-zinc-500 mt-1">Mother tongue</p>
            </div>
            <div className="bg-zinc-800/50 backdrop-blur-sm p-6 rounded-xl border border-zinc-700/50 text-center">
              <span className="text-4xl mb-3 block">🇬🇧</span>
              <h4 className="text-lg font-bold text-white">English</h4>
              <p className="text-green-400 font-medium">Advanced (C1)</p>
              <p className="text-sm text-zinc-500 mt-1">Professional proficiency</p>
            </div>
            <div className="bg-zinc-800/50 backdrop-blur-sm p-6 rounded-xl border border-zinc-700/50 text-center">
              <span className="text-4xl mb-3 block">🇩🇪</span>
              <h4 className="text-lg font-bold text-white">German</h4>
              <p className="text-yellow-400 font-medium">Intermediate (A2/B1)</p>
              <p className="text-sm text-zinc-500 mt-1">Actively improving</p>
            </div>
          </div>
        </motion.div>
      </div>
